...
class Alfamidi extends BaseController
{
    ...
    public function view($id)
    {
        ...
        return view('Alfamidi/ViewMidi', $data);
    }
    ...
    public function getMapData()
    {
        ...
        $data = $db->table('d_midi a')
            ...
            -- Nilai gabungan supaya popup lama tetap jalan
            COALESCE(mni.kecepatan_bandwidth, qs.quota_internet) AS kapasitas_bandwidth,
        ...
        // ── Pemilik Project & VPN diambil lewat Model (aman dari salah nama tabel) ──
        $pemilikMap = [];

...
/**
 * @var array $midi         Data toko yang sedang diedit
    ...
    <div id="container" class="pc-container ml-sidebar min-h-screen transition-[margin] duration-200">
        ...
        <div class="p-6">
            <div class="page-wrapper">
                ...
                <div class="form-card">
                    <form action="<?= site_url('Alfamidi/update') ?>" method="POST" id="FormMidi" enctype="multipart/form-data">
                        <?= csrf_field() ?>
   ...
   ════════════════════════════════════════════════ */
    ...
    <script>
        ...
        document.getElementById('FormMidi').addEventListener('submit', function(e) {
            ...
            if (window.__editSnapshot != null) {
                ...
                const tidakBerubah = window.__serializeFormMidi() === window.__editSnapshot &&
    ...
    <script>
        ...
        /* ════════════════════════════════════════════════
           ...
           ════════════════════════════════════════════════ */
        window.__serializeFormMidi = function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.__editSnapshot = window.__serializeFormMidi();

                    ...
                    <form action="<?= site_url('Alfamidi/save') ?>" method="POST" id="FormMidi" enctype="multipart/form-data">
                        ...
                        <div class="grid-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_alfamidi" placeholder="Masukan Nama Alfamidi" required class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat_alfamidi" placeholder="Masukan Alamat Toko" required class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none">
                            </div>
                            <div class="form-group">

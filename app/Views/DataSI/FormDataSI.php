...
<body class="text-[#37474f] dark:text-[#bfc8d6]">
                ...
                <div class="form-card">
                    <form action="<?= site_url('DataSI/save') ?>" method="POST" id="FormDataSI">
                        ...
                        <div class="grid-2">
                            ...
                            <div class="form-group">
                                <label>Isi Quota Internet Sim Card ( Gbps / Mbps / Kbps )</label>
    ...
    <script>
        ...
        function toRupiah(angka) {
            ...
            const raw = String(angka).split('.')[0].replace(/\D/g, '');
...
<script>
    // Batasi input hanya angka untuk MSISDN & ISSID/IMEI
    ['nomor_msisdn', 'nomor_issid_imei'].forEach(function(id) {

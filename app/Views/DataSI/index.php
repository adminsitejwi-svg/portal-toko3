                            ...
                            <div class="bg-white rounded-xl shadow-xl w-full max-w-xl overflow-hidden">
                                ...
                                <div class="p-6 max-h-[75vh] overflow-y-auto">
                                    ...
                                    <div class="border rounded-lg divide-y">
                                        ...
                                        <div class="flex justify-between px-4 py-2.5 text-sm">
                                            <span class="text-gray-500">Nama Vendor / Penyedia Layanan</span>
                                        ...
                                        <div class="flex justify-between px-4 py-2.5 text-sm">
                                            <span class="text-gray-500">Isi Quota Internet</span>
                                            <span class="font-medium text-right" id="detail_quota">-</span>
                                        </div>
                                        <div class="flex justify-between px-4 py-2.5 text-sm">
                                            <span class="text-gray-500">Harga Paket Quota</span>
                                            <span class="font-medium text-right" id="detail_harga">-</span>
                                        </div>
                                        <div class="flex justify-between px-4 py-2.5 text-sm">
                                            <span class="text-gray-500">Nomor MSISDN</span>
                                            <span class="font-medium text-right" id="detail_msisdn">-</span>
                                        </div>
                                        <div class="flex justify-between px-4 py-2.5 text-sm">
                                            <span class="text-gray-500">Nomor ISSID / IME</span>
                                            <span class="font-medium text-right" id="detail_imei">-</span>
                                        </div>
                                        <div class="flex justify-between px-4 py-2.5 text-sm">
                                            <span class="text-gray-500">Kategori Pelanggan</span>
                                            <span class="font-medium text-right" id="detail_kategori">-</span>
                                        </div>
        ...
        function openDetailModal(id) {
            fetch("<?= site_url('DataSI/show/') ?>" + id)
                ...
                .then(json => {
                    ...
                    document.getElementById('detail_quota').textContent = d.isi_quota_internet ?? '-';
                    document.getElementById('detail_msisdn').textContent = d.nomor_msisdn ?? '-';
                    document.getElementById('detail_imei').textContent = d.nomor_imei ?? '-';
                    document.getElementById('detail_kategori').textContent = d.kategori_pelanggan ?? '-';
                    ...
                    if (d.harga_quota_internet !== null && d.harga_quota_internet !== '' && d.harga_quota_internet !== undefined) {
                        const raw = String(d.harga_quota_internet).split('.')[0].replace(/\D/g, '');

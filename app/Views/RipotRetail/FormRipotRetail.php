...
<head>
    ...
    <title>Form Report Retail & Corporate</title>
...
<body class="text-[#37474f] dark:text-[#bfc8d6]">
    ...
    <div id="container" class="pc-container ml-sidebar min-h-screen transition-[margin] duration-200">
        ...
        <div class="p-6">
            <div class="form-container">
                <h2>Form Report Retail & Corporate</h2>
                <form action="<?= site_url('RipotRetail/save') ?>" method="POST" id="ripotForm">
                    <?= csrf_field() ?>
                    <div class="form-group mt-3">
                        <label>Daily</label>
                        <textarea name="daily" id="daily" rows="2"
                            placeholder="Masukkan Daily"
                            class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none"><?= old('daily') ?></textarea>
                    </div>
                    <div class="form-group mt-5">
                        ...
                        <select name="shift" id="shift" required class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none">
                            <option value="" class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none">Pilih Shift</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="client" id="client" required
                            value="<?= old('client') ?>" placeholder="Masukkan Nama Client">
                    </div>
                        ...
                        <div style="display:flex;gap:15px;margin-top:12px">
                            ...
                            <div style="flex:1">
                                ...
                                <input type="number" min="0" name="duration_minute" id="duration_minute" readonly class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none"
                                    value="<?= old('duration_minute') ?>" placeholder="Otomatis" style="background:#f1f5f9">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jenis_layanan" id="jenis_layanan"
                            value="<?= old('jenis_layanan') ?>" placeholder="Masukan Jenis Layanan">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="problem" id="problem" rows="3" required
                            ...
                            class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none"><?= old('problem') ?></textarea>
                    </div>
                    ...
                    <div class="form-group" style="display:flex;gap:15px">
                        <div style="flex:1">
                            ...
                            <input type="text" name="action" id="action"
                                value="<?= old('action') ?>" placeholder="Masukan Action">
                        </div>
                        <div style="flex:1">
                            <label>Solver</label>
                            <input type="text" name="solver" id="solver"
                                value="<?= old('solver') ?>" placeholder="Masukkan Solver">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="note" id="note" rows="2"
                            ...
                            class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none"><?= old('note') ?></textarea>
                    </div>
                        ...
                        <div style="display:flex;gap:15px" class="mt-4">
                            <div style="flex:1">
                                ...
                                <input type="hidden" name="backup_duration_hour" id="backup_duration_hour"
                                    value="<?= old('backup_duration_hour') ?>">
                            </div>
                            <div style="flex:1">
                                ...
                                <input type="number" min="0" name="backup_duration_minute" id="backup_duration_minute" readonly class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none"
                                    value="<?= old('backup_duration_minute') ?>" placeholder="Otomatis" style="background:#f1f5f9">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="regards" id="regards"
                            value="<?= old('regards') ?>" placeholder="Masukkan Regards">
                    </div>
                    <div style="flex:1">
    ...
    <script>
        function autoDuration(startId, finishId, hourId, minuteId) {
            ...
            const hourEl = document.getElementById(hourId); // hidden (angka, ke DB)
            const hourDisplayEl = document.getElementById(hourId + '_display'); // tampilan 1:00:00
            ...
            function calc() {
                ...
                hourDisplayEl.value = h + ':' + p(m) + ':00'; // tampil: 1:00:00
                hourEl.value = h; // tersimpan: 1
                minuteEl.value = totalMinutes; // tampil & tersimpan: 60
            }

    ...
    <div id="container" class="pc-container ml-sidebar min-h-screen transition-[margin] duration-200">
        ...
        <div class="p-6">
            <div class="page-wrapper">
                ...
                <div class="form-card">
                    <form action="<?= site_url('Alfamart/save') ?>" method="POST" id="FormMidi" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="grid-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_alfamart" placeholder="Masukan Nama Alfamart" required class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat_alfamart" placeholder="Masukan Alamat Toko" required class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none">
                            </div>
                            <div class="form-group">

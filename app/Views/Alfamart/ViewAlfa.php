...
/**
 * @var array $alfamart         Data toko yang sedang dilihat (read-only)
        ...
        <div class="p-6">
            <div class="page-wrapper">
                <div class="page-header">
                    <div>
                        <h2>Detail Data Toko Alfamart</h2>
                ...
                <div class="form-card">
                    <form action="javascript:void(0)" id="FormMidi" enctype="multipart/form-data">
                        ...
                        <div class="action-bar">
                            <button type="button" class="btn-save" onclick="window.location.href='<?= site_url('Alfamart/edit/' . $alfamart['id']) ?>'"><i class="ti ti-edit"></i> Edit Data</button>

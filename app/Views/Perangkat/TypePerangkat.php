...
<body class="text-[#37474f] dark:text-[#bfc8d6]">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <input
                                                ...
                                                name="type_perangkat" placeholder="Masukan type perangkat"
                                                class="w-full border rounded-lg p-3">
                                        </div>
                                        <div class="md:col-span-2">
                                            <label>Status</label>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="border rounded-lg divide-y">
                                        <div class="flex justify-between px-4 py-2.5 text-sm">
                                            <span class="text-gray-500">Jenis Perangkat</span>
                                            <span class="font-medium text-right" id="detail_jenis">-</span>
                                        </div>
                                        <div class="flex justify-between px-4 py-2.5 text-sm">
                                        ...
                                        <div class="flex justify-between px-4 py-2.5 text-sm">
                                            <span class="text-gray-500">Type Perangkat</span>
                                            <span class="font-medium text-right" id="detail_type">-</span>
                                        </div>
    ...
    <script>
        function openDetailModal(id) {
            fetch("<?= site_url('TypePerangkat/show/') ?>" + id)
                .then(res => {
                ...
                .then(json => {
                    ...
                    document.getElementById('detail_ringkas').textContent =
                        'Data Type Perangkat ( ID: ' + d.id + ' ) ';

                    document.getElementById('detail_jenis').textContent = d.jenis_perangkat ?? '-';
                    document.getElementById('detail_merek').textContent = d.merk_perangkat ?? '-';
                    document.getElementById('detail_type').textContent = d.type_perangkat;
